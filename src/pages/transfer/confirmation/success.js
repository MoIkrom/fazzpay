            ...
            <section className={`d-flex justify-content-center mt-5`}>
              <span>
                <div className={`d-flex justify-content-center`}>
                  <Image src={checklist} alt="checklist" width={50} height={50} />
                </div>
            ...
            <section className={`d-flex flex-column mt-5`}>
              <div className={`${css.box}`}>
                <span>
                  ...
                  <div className={`${css.detailBox}`}>{costing(transactions.amount)}</div>
                </span>
              </div>
              <div className={`${css.box}`}>
                <span>
            ...
            <section className={`d-flex flex-column mt-5`}>
              ...
              <div className={`${css.box} ${css.container}`}>
                ...
                <span className={`${css.profilDetail}`}>
                  ...
                  <div className={`${css.Phone}`}>{data.noTelp === null ? "this user dont input number phone" : data.noTelp}</div>
                </span>
              </div>
            </section>

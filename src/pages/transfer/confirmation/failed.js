          ...
          <div className={`col-lg-9 col-md-8 col-sm-12 ${css.content_right}`}>
            <section className={`d-flex justify-content-center mt-5`}>
              <span>
                ...
                <div className={`d-flex justify-content-center`}>
                  <div className={`${css.failDetail}`}>We can`t transfer your money at the moment, we recommend you to check your internet connection and try again.</div>
                </div>
              </span>
            </section>
            <section className={`d-flex flex-column mt-5`}>
              ...
              <div className={`${css.box}`}>
                <span>
                  ...
                  <div className={`${css.detailBox}`}>For buying some socks</div>
                </span>
              </div>
            </section>
            <section className={`d-flex flex-column mt-5`}>
